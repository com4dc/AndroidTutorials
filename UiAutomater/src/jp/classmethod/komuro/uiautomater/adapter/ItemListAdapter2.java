...
public class ItemListAdapter2 extends ArrayAdapter<ItemDto> {
	...
	public ItemListAdapter2(Context context, int resource, int textViewResourceId) {
	...
	public ItemListAdapter2(Context context, int resource,
