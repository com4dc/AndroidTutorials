...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs) {
        ...
        int numberPickerLayoutId = getInternalResrouce("number_picker", "layout");
        LayoutInflater inflater =
                (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(numberPickerLayoutId, this, true);
        mHandler = new Handler();
        
        final int incrementId = getInternalResrouce("increment", "id");
        final int decrementId = getInternalResrouce("decrement", "id");
        ...
        OnClickListener clickListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                if (incrementId == v.getId()) {
                    changeCurrent(mCurrent + 1);
                } else if (decrementId == v.getId()) {
                    changeCurrent(mCurrent - 1);
                }
            }
        };
        ...
        mIncrementButton = (NumberPickerButton) findViewById(incrementId);
        mIncrementButton.setOnClickListener(clickListener);
        mIncrementButton.setOnLongClickListener(longClickListener);
        mIncrementButton.setNumberPicker(this);

        mDecrementButton = (NumberPickerButton) findViewById(decrementId);
        mDecrementButton.setOnClickListener(clickListener);
        mDecrementButton.setOnLongClickListener(longClickListener);
        mDecrementButton.setNumberPicker(this);

        int timePickerInputId = getInternalResrouce("timepicker_input", "id");
        mText = (EditText) findViewById(timePickerInputId);
